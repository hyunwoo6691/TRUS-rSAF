...
stTRInfo.nPitch = 2.1e-3;
stTRInfo.nWidth = 2e-3;
stTRInfo.nHeight = 2e-3;
...
% stTxInfo.num_tx_vol = 280*3+1; % volume scan - half theta (0.1564)
...
nTc = 1 / stRFInfo.nFc;
nUpsampleFactor = 5;
nSample = 2500; % 7.26 cm view depth
...
for p_idx = 1:stTxInfo.num_tx_vol
