...
if(~load_scatter)
    ...
    for d_idx = 1:numel(depth_pos)
        ...
        m_point_pos = cat(1,m_point_pos, [0 0 depth_pos(d_idx)]);
    end
...
for t_idx = 1:stTxInfo.num_tx_plane
    ...
    [mRF, nStartTime] = calc_scat_multi(pTxAperture, pRxAperture, m_scat_total, m_amp_total);
    ...
    % save scanline data
    save([save_dir_data '/PW_' num2str(t_idx, '%.3d')], 'mRcvData');
    toc;
end
