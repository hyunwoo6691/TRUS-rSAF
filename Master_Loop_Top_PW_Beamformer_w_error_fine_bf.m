...
if(bSave)
    ...
    stParam.mImgY = mImgY;
    stParam.mImgZ = mImgZ;
    save([dir_ '/Parameters_'], 'stParam', '-v7.3');
end
%%
...
%             load([dir_data '/' data_list(idx).name '/PW_016.mat']); % get planewave transmitted at 0 deg
            % load([dir_data '/' data_list(idx).name '/PW_001.mat']); % get planewave transmitted at 0 deg
