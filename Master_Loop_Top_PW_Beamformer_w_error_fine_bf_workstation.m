...
%%
dir_master = pwd;
dir_ = [dir_master '/data/prostate_mimic/OPT'];
...
sample_start = input('Enter the start index: ');
sample_end = input('Enter the end index: ');
...
%%
for s_idx = sample_start:sample_end
